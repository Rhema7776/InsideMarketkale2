    ...
    <footer class="bg-white dark:bg-gray-900 py-10 xs:max-lg:px-3">
        <div class="container mx-auto w-full ">
          ...
          <div class="sm:flex sm:items-center sm:justify-between">
              <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://Insidemarket.com/" class="hover:underline">InsideMarket™</a>. All Rights Reserved.
              </span>
